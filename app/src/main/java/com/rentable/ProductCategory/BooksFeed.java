...
public class BooksFeed extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
                ...
                new FirebaseRecyclerAdapter<ProductInfo, ProductView>(options)
                {
                    ...
                    protected void onBindViewHolder(@NonNull ProductView holder, int i, @NonNull ProductInfo model) {
                        ...
                        holder.mRentPrduct.setOnClickListener(new View.OnClickListener() {
                            ...
                            {
                                Intent intent = new Intent(BooksFeed.this, RentActivity.class);
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent intent = new Intent(BooksFeed.this, CategoriesActivity.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if(id == R.id.nav_rent)
        {
            Intent intent = new Intent(BooksFeed.this, ProductInfoActivity.class);
        ...
        {
            Intent intent = new Intent(BooksFeed.this, SettingsActivity.class);
            startActivity(intent);
        }
        else if(id == R.id.nav_logout)
        {
            ...
            Toast.makeText(BooksFeed.this, "You Logged out Successfully", Toast.LENGTH_SHORT).show();
        ...
        {
            Intent intent = new Intent(BooksFeed.this, PostedItemsActivity.class);
        ...
        else if(id == R.id.nav_homefeed)
        {
            ...
            Intent intent = new Intent(BooksFeed.this, NavigationActivity.class);
            startActivity(intent);
        }
